...
async def main():
    ...
    wb_sheet_seasons.append(('Season Title', 'Season Name', 'Tier', 'Tier Name', 'Tier Rarity', 'Tier Category'))
    x = 1
    while True:
        ...
        for tier in season.tiers:
            ...
            wb_sheet_seasons.append((season.title.name, season.name, tier.tier, tier.name, tier.rarity, tier.category))
